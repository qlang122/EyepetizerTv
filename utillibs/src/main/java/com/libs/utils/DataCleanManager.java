...
public class DataCleanManager {
     ...
     * @param filepath
     */
    public static void cleanApplicationData(@NonNull Context context, String... filepath) {
     ...
     * @param directory
     */
    private static void deleteFilesByDirectory(@NonNull File directory) {
    ...
    public static String getCacheSize(@NonNull File file) throws Exception {
